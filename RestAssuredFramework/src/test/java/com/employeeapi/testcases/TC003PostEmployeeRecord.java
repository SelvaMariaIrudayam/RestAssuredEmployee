...
public class TC003PostEmployeeRecord extends TestBase{
	...
	**********************************************************/
		...
		@Test
		void checkResposeBody()//java.lang.AssertionError: expected [200] but found [429] --too many requests
		...
		@Test
		void checkContentType()//java.lang.AssertionError: expected [text/html; charset=UTF-8] but found [application/json]
